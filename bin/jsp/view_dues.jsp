...
<script type="text/javascript" charset="utf-8">
	...
	function mouseHandle() {	       
        var tr = $('#viewDuesSummaryTable').find('tr');
        tr.hover(
             function() {  // mouseover
	...
	function getData() {
		// "/shopnowat" 
		var destination = "/reports/getdues.htm";
		$.ajax({
			type : "get",
			url : destination,
			cache : false,
	...
	function duesResponseHandlerAdapter(result){
		$("#viewDuesSummaryTable").append("<tbody>");
		...
		$("#viewDuesSummaryTable").append(newRow);
		}
		$("#viewDuesSummaryTable").append("</tbody>");
		var options = {
			...
			$('#viewDuesSummaryTable').tableFilter(options);
		mouseHandle();
		displayDuesSummary();
	}
...
<body>
	<form method="post">
		...
		<div id="viewDuesSummaryTableDiv">
			<table id="viewDuesSummaryTable" class="shopnowatTable" width="95%" cellspacing="0"
				cellpadding="5">
