...
<script type="text/javascript" charset="utf-8">
	...
	function mouseHandle() {	       
        var tr = $('#viewPaidSummaryTable').find('tr');
        tr.hover(
             function() {  // mouseover
	...
	function getData() {
		// "/shopnowat" 
		var destination = "/reports/getpaidservice.htm";
		$.ajax({
			type : "get",
			url : destination,
			cache : false,
	...
	function duesResponseHandlerAdapter(result){
		$("#viewPaidSummaryTable").append("<tbody>");
		...
		$("#viewPaidSummaryTable").append(newRow);
		}
		$("#viewPaidSummaryTable").append("</tbody>");
		var options = {
			...
			$('#viewPaidSummaryTable').tableFilter(options);
		mouseHandle();
		//displayDuesSummary();
	}
...
<body>
	<form method="post">
		...
		<div id="viewPaidSummaryTableDiv">
			<table id="viewPaidSummaryTable" class="shopnowatTable" width="95%" cellspacing="0"
				cellpadding="5">
